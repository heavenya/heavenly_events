          ...
          child: Padding(
            ...
            child: CircularShadow(
              child: SvgPicture.asset(
                addCardController.isArabic == true
                            ...
                            GestureDetector(
                              onTap: () async {
                                if (controller.formKey.currentState!
                                  ...
                                  String number = controller.cardNumber
                                      .substring(
                                          controller.cardNumber.length - 4);
                                  sp.setString('cNumber',
                                      controller.cardNumber.toString());
                                  // sp.setString('cNumber',number.toString());
                                  sp.setString('cName',
                                      controller.cardHolderName.toString());
                                  sp.setString('cDate',
